<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-5 mt-16" id="portfolio">
    ...
    <div
        class="lg:col-span-3 glass-panel glass-panel-hover card-shine rounded-2xl p-10 flex flex-col justify-between group reveal stagger-7">
        <div class="flex justify-between items-start">
            <div
                class="w-14 h-14 rounded-xl hero-gradient flex items-center justify-center shadow-lg shadow-blue-500/20 icon-glow">
                <span class="material-symbols-outlined text-white text-3xl">cloud</span>
            </div>
            <span class="material-symbols-outlined text-primary arrow-reveal">arrow_outward</span>
        </div>
        <div class="mt-8">
